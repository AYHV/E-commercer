...
const Page = () => {
    ...
    return (
        <div className="min-h-srceen bg-gray-100 p-4">
            <div className="max-w-6xl mx-auto">
                <h1 className="text-">Products</h1>
                <div className="">
                    <button onClick={AddProducts} className="bg-green-600 hover:bg-green-700 text-2xl text-white rounded-md px-6 py-3 rounded-lg mb-8 transition duration-300 ease-in-out flex items-center gap-2">
